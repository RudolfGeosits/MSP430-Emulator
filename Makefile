...
clean :
	rm main.o server.o utilities.o registers.o memspace.o debugger.o disassembler.o register_display.o decoder.o flag_handler.o formatI.o formatII.o formatIII.o usci.o port1.o *~
